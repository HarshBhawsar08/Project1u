...
import image from '../../public/images/Glycolysis.jpeg';

function Biochemistry() {
    const topics = [
        { id: 1, title: "Glycolysis and gluconeogenesis", rating: 4.5, img: image, mcqs: 30 },
        { id: 2, title: "ETC and bioenergetics", rating: 4.5, img: image, mcqs: 18 },
        { id: 3, title: "Krebs Cycle", rating: 4.5, img: image, mcqs: 18 },
        { id: 4, title: "HMP shunt pathway, Fructose", rating: 4.5, img: image, mcqs: 15 },
    ];
