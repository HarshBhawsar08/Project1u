...
function User() {
  return (
    <>
      ...
      <Link to="/anatomy" className='text-decoration-none text-dark'>
      ...
      <Link to="/biochemistry" className='text-decoration-none text-dark'>
      ...
      <Link to="/physiology" className='text-decoration-none text-dark'>
        <div className="card col-md-10 mx-auto mt-4 shadow border border-gradient rounded-3 p-3 bg-light">
          <div className="d-flex align-items-center">
